...
Specifically, lines with the following formats are extracted:
    ...
    SparqlBlocks.SOME_KEY = 'Some value';
...
The file qqq.json would get:
    ...
    "SparqlBlocks.SOME_KEY", "Here is a description of the following message.",
...
_INPUT_DEF_PATTERN = re.compile("""SparqlBlocks.Msg.(\w*)\s*=\s*'([^']*)';?$""")

_INPUT_SYN_PATTERN = re.compile(
    """SparqlBlocks.Msg.(\w*)\s*=\s*SparqlBlocks.Msg.(\w*);""")
