...
Blockly.Blocks.sparql_execution_error={init:function(){this.setHelpUrl("http://www.example.com/");this.setColour(330);this.appendDummyInput().appendField("Error executing query!");this.appendDummyInput().appendField("Error Name").appendField(new Blockly.FieldTextInput("ERROR TYPE"),"ERRORTYPE");this.appendDummyInput().appendField("Description").appendField(new Blockly.FieldTextInput("ERROR"),"ERRORDESCR");this.setOutput(!0,"Table");this.setTooltip("");this.setDeletable(!1);this.setMovable(!1);this.setEditable(!1)}};/*
 ...
 limitations under the License.
*/
SparqlBlocks.Blocks.logic={};var typeExt=SparqlBlocks.Types.getExtension,typeContentExt=function(a){return typeExt("Var"==a?"Expr":a)};SparqlBlocks.Blocks.logic.HUE=210;
...
SparqlBlocks.Sparql.sparql_logic_ternary=function(a){var b=SparqlBlocks.Sparql.valueToCode(a,"IF",SparqlBlocks.Sparql.ORDER_COMMA)||"false",c=SparqlBlocks.Sparql.valueToCode(a,"THEN",SparqlBlocks.Sparql.ORDER_COMMA)||'""';a=SparqlBlocks.Sparql.valueToCode(a,"ELSE",SparqlBlocks.Sparql.ORDER_COMMA)||'""';return["IF("+b+", "+c+", "+a+")",SparqlBlocks.Sparql.ORDER_FUNCTION_CALL]};/*
 ...
 limitations under the License.
*/
SparqlBlocks.Sparql.main={};SparqlBlocks.Sparql.main.VIRTUOSO_PATCH=!0;var localNameEsc=function(a){return a.split("").map(function(a){return _.contains("_~.-!$&'()\\*+,;=/?#@%".split(""),a)?"\\"+a:a}).join("")};
...
SparqlBlocks.Sparql.variables_get=function(a){return["?"+a.getFieldValue("VAR"),SparqlBlocks.Sparql.ORDER_ATOMIC]};/*
