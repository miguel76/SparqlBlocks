...
"ASC"],["\u2191","DESC"]]),"ORDER_DIRECTION2");this.appendDummyInput().appendField("& limit to first").appendField(new Blockly.FieldTextInput("10"),"LIMIT").appendField("rows");this.setOutput(!0,"Select");this.setInputsInline(!0);this.setTooltip("")}};
