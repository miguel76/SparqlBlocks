...
Blockly.Blocks.sparql_typedsubject_propertylist={init:function(){_initSubject(this);this.appendValueInput("SUBJECT").setCheck(typeExt("ResourceOrVar"));this.appendValueInput("TYPE").setCheck(typeExt("ResourceOrVar")).appendField("is a");this.appendStatementInput("PROPERTY_LIST").setCheck("PropertyList").appendField("  & has");this.setInputsInline(!0);this.setPreviousStatement(!0,"TriplesBlock");this.setNextStatement(!0,"TriplesBlock");this.setTooltip("")}};
Blockly.Blocks.sparql_anonsubject_propertylist={init:function(){_initSubject(this);this.appendStatementInput("PROPERTY_LIST").setCheck("PropertyList").appendField("s.t. has");this.setInputsInline(!0);this.setOutput(!0,"Resource");this.setTooltip("")}};
...
Blockly.Blocks.sparql_union={init:function(){this.setHelpUrl("http://www.example.com/");this.setColour(260);this.appendStatementInput("OP1").setCheck("TriplesBlock").appendField("it happens that");this.appendStatementInput("OP2").setCheck("TriplesBlock").appendField("and/or that");this.setInputsInline(!0);this.setPreviousStatement(!0,"TriplesBlock");this.setNextStatement(!0,"TriplesBlock");this.setTooltip("")}};
...
Blockly.Blocks.variables_get=Blockly.Blocks.sparql_variable;Blockly.Blocks.variables_set=null;/*
 ...
 limitations under the License.
*/
SparqlBlocks.Sparql.bgp={};SparqlBlocks.Sparql.sparql_verb_object=function(a){var b=SparqlBlocks.Sparql.valueToCode(a,"VERB",SparqlBlocks.Sparql.ORDER_ATOMIC);a=SparqlBlocks.Sparql.valueToCode(a,"OBJECT",SparqlBlocks.Sparql.ORDER_ATOMIC);return b?b+" "+(a?a:"[]")+SparqlBlocks.Sparql.STMNT_BRK:""};
...
var generateAnonSubject=function(a,b){return[a||""!=b?"[\n"+(a?" a "+a+(""!=b?";\n":""):"")+(""!=b?b:"")+"\n]":"[]",SparqlBlocks.Sparql.ORDER_ATOMIC]};SparqlBlocks.Sparql.sparql_anontypedsubject_propertylist=function(a){var b=SparqlBlocks.Sparql.valueToCode(a,"TYPE",SparqlBlocks.Sparql.ORDER_ATOMIC);a=SparqlBlocks.Sparql.stmJoin(SparqlBlocks.Sparql.statementToCode(a,"PROPERTY_LIST"),";\n");return generateAnonSubject(b,a)};
SparqlBlocks.Sparql.sparql_anonsubject_propertylist=function(a){a=SparqlBlocks.Sparql.stmJoin(SparqlBlocks.Sparql.statementToCode(a,"PROPERTY_LIST"),";\n");return generateAnonSubject(null,a)};/*
