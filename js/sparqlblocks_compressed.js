...
"sparql_table");c.initSvg();for(var d=b.head.vars,e=b.results.bindings,f=d.length,g=0;g<f;g++){c.appendValueInput("COL"+(g+1)).setCheck("Column");var h=c.getInput("COL"+(g+1)).connection,l=d[g];colBlockFromVar_(l,e.map(function(a){return a[l]}),a,h)}return c};SparqlBlocks.Output.blocksFromSelectResults=blocksFromSelectResults_;var fillTableFromSelectResults_=function(a,b){var c=b.head.vars,d=getTableHeaders(c);a.append(d);d=b.results.bindings;for(rowIdx in d)a.append(getTableRow(c,d[rowIdx]))};/*
